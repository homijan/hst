...
$`\begin{equation}
H_{HFO}(q, v) = \sum_i^N \frac{1}{2} m v_i^2 + \frac{1}{2} m \omega^2 q_i^2 = \frac{1}{2} m \sum_i^N v_i^2 + \frac{1}{2} m \omega^2 \sum_i^N q_i^2 = \frac{1}{2} m N \left<v^2\right> + \frac{1}{2} m \omega^2 N \bar{\left(q^2\right)} \overset{^{i \rightarrow \infty}_{as~\rho(q)}}{\Rightarrow} \int \rho(q) \left( \frac{1}{2} v(q)^2 + \frac{1}{2} \omega^2 q^2 \right) dq,
\end{equation}`$
