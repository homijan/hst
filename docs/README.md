...
$`\begin{align}
\frac{\frac{\mathcal{f}(x_i, t_n) - \mathcal{f}(x_i, t_{n-1})}{\rho(x_i, t_n) - \rho(x_i, t_{n-1})} - \frac{\mathcal{f}(x_{i-1}, t_n) - \mathcal{f}(x_{i-1}, t_{n-1})}{\rho(x_{i-1}, t_n) - \rho(x_{i-1}, t_{n-1})}}{\Delta x_i} + 2 \rho(x_i, t_n)^2 \varepsilon(x_i, t_n) + 2 \rho(x_i, t_n) \frac{\mathcal{f}(x_i, t_n) - \mathcal{f}(x_i, t_{n-1})}{\Delta t} = 0,
\end{align}`$
