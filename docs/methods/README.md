...
$`z_k(z) = z - \frac{z}{|z|}\quad and\quad z(z_k) :=  R_0(z_k) = z_k + \frac{z_k}{|z_k|}\quad\Rightarrow\quad R_0\left(z - \frac{z}{|z|}\right) = \left(z - \frac{z}{|z|}\right) + \frac{\left(z - \frac{z}{|z|}\right)}{\left|z - \frac{z}{|z|}\right|}`$
